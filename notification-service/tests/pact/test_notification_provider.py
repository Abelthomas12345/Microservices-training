...
# @pytest.mark.django_db
# def test_notification_provider_honors_contract(live_server) -> None:
#     """Vérifie que le notification-service respecte le contrat."""
    
#     # Configuration du verifier pour pact-python 1.7.0
#     verifier = Verifier(provider=PROVIDER_NAME)
    
#     # Ajout du fichier de contrat
#     verifier.add_source(str(PACT_FILE))
    
#     # Configuration de l'URL du provider
#     verifier.provider_base_url = live_server.url
    
#     # Configuration du handler d'état (si supporté)
#     # En version 1.7.0, la syntaxe peut varier
#     try:
#         verifier.state_handler(handle_provider_state)
#     except AttributeError:
#         # Certaines versions n'ont pas state_handler
#         pass
...
#         pytest.fail(f"La vérification du contrat a échoué : {e}")